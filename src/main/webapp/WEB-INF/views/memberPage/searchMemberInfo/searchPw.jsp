	...
	<div class="content_div">
		...
		<span class="use_phone_span">회원정보에 등록한 휴대전화 번호와 입력한 휴대전화 번호가 같아야, 인증번호를 받을 수 있습니다.</span>
			...
			<div id="use_phone_click">
				...
				<tr>
				<td>휴대전화</td> <td> <input id="phoneInput"> </td> <td> <button  id="btn_group1">인증번호 받기</button> </td>
				</tr>
				<tr>
				<td colspan="3"> <input> </td>
				</tr>
				<tr>
				<td colspan="3"> <button id="btn_group1">인증하기</button> </td>
				</tr>
				</table>
			</div>
		</div>
		...
		<span class="use_phone_span">본인확인 이메일 주소와 이메일 주소가 같아야, 인증번호를 받을 수 있습니다.</span>
			...
			<table border="1" class="table">
				...
				<tr>
				<td>이메일</td> <td> <input id="emailInput"> </td> 
				<td> <button type="button" class="emailBtnForPw" id="btn_group1">인증메일 보내기</button> </td>
				</tr>
				</table>
			</div>
		</div>
