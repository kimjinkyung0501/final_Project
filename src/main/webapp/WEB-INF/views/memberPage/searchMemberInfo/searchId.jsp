...
<section class="search_section">
	<header class="search_header">
		<span class="header_1">아이디 찾기</span>
		<span class="header_2">아이디 찾기 방법을 선택해 주세요</span>
	</header>
	<div class="content_div">
		...
		<span class="use_phone_span">본인확인 이메일 주소와 이메일 주소가 같아야, 인증번호를 받을 수 있습니다.</span>
			...
			<table border="1">
				...
				<tr>
				<td>이메일</td> <td> <input id="emailInput"> </td> <td> <button type="button" class="emailBtnForId">인증메일 보내기</button> </td>
				</tr>
				</table>
			</div>
		</div>
