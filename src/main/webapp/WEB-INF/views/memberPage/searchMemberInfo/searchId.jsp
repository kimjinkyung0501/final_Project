	...
	<section class="search_section">
		...
		<div class="content_div">
			<div class="use_phone">
				...
				<span class="use_phone_span">회원정보에 등록한 휴대전화 번호와 입력한 휴대전화 번호가
					같아야, 인증번호를 받을 수 있습니다.</span>
					<div style="width: 100%; min-height: 1px; height: 30px;"></div>
				<div id="use_phone_click">
					<table class="table" >
						<tr>
							<td>이름</td>
							<td><input id="nameInput1"></td>
						</tr>
						<tr>
							<!-- 8월 14일 추가 -->
							<td>휴대전화</td>
							...
							<td>
								<button class="searchIdByPhone">인증번호 받기</button>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<!-- 8월 14일 추가 -->
							<td colspan="3">
								<button class="submitPhoneKeyBtn">인증하기</button>
							</td>
						</tr>
					</table>
				</div>
			...
			<div class="use_email">
				...
				<span class="use_phone_span">본인확인 이메일 주소와 이메일 주소가 같아야, 인증번호를
					받을 수 있습니다.</span>
					<div style="width: 100%; min-height: 1px; height: 30px;"></div>
				<div id="use_email_click">
					<table class="table">
						<tr>
							<td>이름</td>
							<td><input id="nameInput2"></td>
						</tr>
						<tr>
							<td>이메일</td>
							<td><input id="emailInput"></td>
							<td>
								<button type="button" class="emailBtnForId">인증메일 보내기</button>
							</td>
						</tr>
					</table>
				</div>
