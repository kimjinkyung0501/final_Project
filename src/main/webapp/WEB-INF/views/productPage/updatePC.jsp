...
<body>
후기 수정
<form action="p_comment.update" method="get">
...
<input type="hidden" name="p_c_pk" value="${param.p_c_pk }">
<input type="hidden" name="p_no" value="${param.p_no }">
<input type="hidden" name="m_id" value="${param.m_id }">
<input type="text" name="p_c_content"><button onclick="moveClose();">수정</button>
