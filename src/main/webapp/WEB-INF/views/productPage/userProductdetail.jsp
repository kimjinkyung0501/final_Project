...
<body>
		...
		<div class="container">
			...
			<form name="newProduct" action="product.reg.do"
				...
				<div class="form-group row">
					...
					<div class="com-sm-3">
						<input type="text" id="name" name="p_name" class="form-control"  value="${p.p_name }">
					</div>
				</div>
	...
	<div class="form-group row">
				...
				<div class="form-group row">
					...
					<div>
<img alt="" src="resources/img/${p.p_photo1}" style="width: 100px; height: 100px;">
